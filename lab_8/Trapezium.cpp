...
void Trapezium::Print() {
  std::cout << "a = " << this->side_a << ", b = " << this->side_b  << ", c = " << this->side_c  << ", d = " << this->side_d << ", Square = " << this->getSquare() << std::endl;
}
...
std::ostream& operator<<(std::ostream& os, const Trapezium& obj) {
  ...
  os << "Length of trapezium is " << obj.side_a << " " << obj.side_b << " " << obj.side_c << " " << obj.side_d << std::endl;
...
double Trapezium::getSquare() {
  double h = std::sqrt(this->side_c * this->side_c - 0.25 * std::pow((this->side_c * this->side_c - this->side_d * this->side_d) / (this->side_b - this->side_a) + this->side_b - this->side_a, 2.0));
